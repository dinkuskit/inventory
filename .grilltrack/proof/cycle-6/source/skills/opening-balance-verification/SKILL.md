...
description: Verify the Inventory-owned opening-balance command, preview/confirmation flow, and local test-only SQLite durability boundary.
---
...
receipt/result shapes, expiry/retry behavior, or their tests.
...
post-expiry exact retry. It never opens a repository database, Cloudflare
resource, production service, or user-selected file.
